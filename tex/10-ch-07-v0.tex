...
We’ve examined the path you actually took (Worldline), the futures available at each tick (Time Cone), and the surrounding terrain (Neighborhoods). But all of this still assumes a single fixed rule set.
