...
\begin{itemize}
  \item an ontology (WARP + DPO as substrate),
  \item a geometry (MRMW, worldlines, curvature),
  \item a physics (CΩSMOS as a WARP graph universe),
...
\begin{quote}
\textbf{Ruliometric science} is the quantitative study of MRMW\emd{}the geometry of the space of all possible computations, rule systems, and universes\emd{}and the machines that move through it.
\end{quote}
...
Right now MRMW\emd{}the space of all WARP graphs + rule sets + histories\emd{}is described
...
\begin{enumerate}
  \item Can we define a Gromov–Hausdorff-type distance between causal WARP graph universes?
...
\begin{itemize}
  ...
  \item Are there "holes" corresponding to classes of universes that can’t be approximated by finite WARP graphs or local DPO rules?
...
\subsubsection*{30.3  Classification of Universes: A Zoo of WARP Graphs}
...
\paragraph{Problem 6: Universality classes of WARP rule sets.}
...
This is a disciplined program for finding WARP graphs that deserve to be CΩSMOS candidates.
...
\begin{itemize}
  \item a large WARP graph evolution (e.g., a CΩMPUTER runtime log),
...
\begin{itemize}
  \item represent WARP graphs natively (graphs of graphs, not forced into arrays),
...
Design families of WARP rule sets that:
...
\begin{itemize}
  \item common WARP / DPO specification languages,
...
\begin{itemize}
  ...
  \item \textbf{If you’re a physicist:}
    \begin{itemize}
      ...
      \item compile it into WARP + DPO cleanly,
