\chapter{WARP Storage Systems (Git, IPLD,
...
\subsection{2. Git as a Primitive WARP Storage
System}\label{git-as-a-primitive-rmg-storage-system}

Git accidentally stumbled into WARP theory 15 years before the math
existed.
...
But the skeleton is unmistakable. Git is the ``Stone Age'' of WARP
storage\emd{}and it proved the model works.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsection{3. IPLD: The First Attempt at Universalizing the WARP
...
This was the first move toward a universal address space for WARP graph
...
\subsection{5. The Core Formal Model: Objects as WARP
...
┌────────┴───────────┐        ┌────────┴───────────┐       ┌────────┴──────────┐
│        Git         │        │        IPLD         │       │      GATOS        │
│   (Naive WARP)     │        │ (Generalized DAG)   │       │(Executable WARP OS)│
└────────────────────┘        └─────────────────────┘       └───────────────────┘
\end{lstlisting}
...
\subsection{7. The Law of WARP Storage}\label{the-law-of-rmg-storage}
