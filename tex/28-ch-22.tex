...
IPFS---they all tried. But every era made the same category mistake:
...
preserving its internal topology---its causal structure, its provenance,
...
Its flaws are exactly the places where it tries---and fails---to hide
its true nature:
...
storage---and it proved the model works.
