...
\section{5.1 --- From Rewrites to Possibility}
...
\section{5.2 --- Chronos, Kairos, Aios: The Three Axes of Computation}
...
\section{5.3 --- The Time Cube: A Local Lens on Rulial Space}
...
\section{5.4 --- Rulial Distance: The Metric on Possibility}
...
\section{5.5 --- Curvature: When the Cone Bends Against You}
...
\section{5.6 --- Storage IS Computation}
...
\section{5.7 --- Transition: From Possibility to Path}
