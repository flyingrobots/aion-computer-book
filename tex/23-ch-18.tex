...
\section{Optimization as Worldline
...
\section{The Optimizer's Input: The Bundle at Each
...
\section{Local Optimization: Following the Gradient of the
...
\section{Global Optimization: Finding
...
\section{Counterfactual Optimization (CFEE + Optimizer =
...
\section{Optimization as ``Rulial
...
\section{Rulial Distance as an Optimization Cost
...
\section{Multi-Model Optimization (MR
...
\section{Transition: From Optimization to
