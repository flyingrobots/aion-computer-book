\chapter{Deterministic Optimization Across Worlds}\label{chapter-18-deterministic-optimization-across-worlds}
...
\section{18.1 --- Optimization as Worldline
...
\section{18.2 --- The Optimizer's Input: The Bundle at Each
...
\section{18.3 --- Local Optimization: Following the Gradient of the
...
\section{18.4 --- Global Optimization: Finding
...
\section{18.5 --- Counterfactual Optimization (CFEE + Optimizer =
...
\section{18.6 --- Optimization as ``Rulial
...
\section{18.7 --- Rulial Distance as an Optimization Cost
...
\section{18.8 --- Low Curvature = Better
...
\section{18.9 --- Multi-Model Optimization (MR
...
\section{18.10 --- Transition: From Optimization to
