\chapter{Rulial Provenance \& Eternal Audit Logs}\label{chapter-19-rulial-provenance-eternal-audit-logs}
...
\section{Recorded Provenance Is a Graph of
...
\section{Why Provenance Matters in WARP Graph
...
\subsection{Analyze Robustness}\label{analyze-robustness}

``Which regions are brittle?'' ``Where does curvature spike?''

\subsection{Design}\label{design-provenance}

``What rules create good geometry?'' ``What invariants create
stability?''

\subsection{Secure}\label{secure}
...
\section{The Eternal Audit Log (EAL)}%
  \label{the-eternal-audit-log}
...
\section{Eternal Logs Enable Impossible
...
\section{Rulial Provenance in Multi-Agent
...
\section{\texorpdfstring{\textbf{The Big Insight:
Computation Is
Narration}}{The Big Insight: Computation Is Narration}}\label{the-big-insight-computation-is-narration}
...
Every WARP state is a page. Every collapse is a sentence. Every bundle is
...
EAL ≈ Union of local Rulial neighborhoods + confluence DAG + provenance
mappings
...
\emph{Part V --- The Architecture of CΩMPUTER.}

We'll carve into the design of the CΩMPILER, the runtime, the engine,
