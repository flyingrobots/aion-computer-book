\chapter*{Part 1 --- Computation as Rewrite}
\addcontentsline{toc}{chapter}{Part 1 --- Computation as Rewrite}
...
\begin{itemize}
    \item Chapters 2–4 build the substrate: WARP Graphs, rewrite rules,
