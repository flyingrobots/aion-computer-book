...
% Heat legend
\node[same] at (0,-2.0) {};
\node[ghost, right=8pt of {(0,-2.0)}] {\footnotesize Identical (transparent)};

\node[warm] at (0,-2.6) {};
\node[ghost, right=8pt of {(0,-2.6)}] {\footnotesize Local divergence (warm)};

\node[hot] at (0,-3.2) {};
\node[ghost, right=8pt of {(0,-3.2)}] {\footnotesize Strong divergence (hot)};

\node[whitehot] at (0,-3.8) {};
\node[ghost, right=8pt of {(0,-3.8)}] {\footnotesize Catastrophic divergence (white-hot)};
...
\centering
\begin{tikzpicture}[
    same/.style={circle, draw=black!30, fill=white, minimum size=5mm},
    ...
    frame/.style={rectangle, rounded corners, draw=gray!50, fill=white, inner sep=8pt, drop shadow}
]
...
\node[labelstyle, align=left] at (1.6,1.8)
...
\node[labelstyle, align=left] at (1.6,-0.8)
