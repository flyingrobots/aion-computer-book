\chapter*{Prologue: Computation Is Transformation}\label{chap:computation-is-transformation}
...
\label{fig:pipeline-isomorphism}
\end{figure}
...
\begin{itemize}
    \item \textbf{Part I} formalizes the substrate—WARP Graphs.
