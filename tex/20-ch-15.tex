...
\section{Sidestepping Into the Time Cone}
...
We call this ``Sidestepping into the Time Cone.'' Imagine time (Chronos) as the Z-axis. The X and Y axes represent the space of valid transformations—the **Kairos**.
